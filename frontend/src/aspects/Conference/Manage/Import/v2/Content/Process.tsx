...
type ErrorInfo = { error: string; rawValue: string };

type PartialOrError<T> = {
    [P in keyof T]?: T[P] | ErrorInfo;
};

type Content_ImportStructure = PartialOrError<{
    conferenceId: string;
    contentId: string;
...
type Content_Element_ImportStructure = PartialOrError<{
    id: string;
    name: string;
...
type Content_Person_ImportStructure = PartialOrError<{
    priority: number;
    id: string;
    roleName: string;
    name: string;
...
type Content_Uploader_ImportStructure = PartialOrError<{
    name: string;
    email: string;
}>;
 ...
 */
function parsePerson(rawValue: string, index: number): Content_Person_ImportStructure {
...
function parseElement(data: any, baseName: string): Content_Element_ImportStructure {
...
function parseItem(data: any): Content_ImportStructure {
